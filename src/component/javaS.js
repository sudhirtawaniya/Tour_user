...
$(document).ready(function(){
    ...
    if ((window.screen.width < 1040) && (window.screen.height > 1040)) {
        var iPad = true;
        $("body").addClass("ipad");
    }
    //OS check========================/
    ...
    //Team slider========================/
    if (($("#team_slider").length) && (window.screen.width > 1040) && (!iPad)) {
        $('#team_slider').slick({
            arrows: true,
            dots: false,
            slidesToShow: 3,
    ...
    if (($("#tour-head-slider").length) && (window.screen.width > 1040) && (!iPad)) {
    ...
    //Tour slider========================/
    if (($("#tour-slider").length) && (window.screen.width > 1040) && (!iPad)) {
        $('#tour-slider').slick({
            arrows: true,
            dots: false,
            slidesToShow: 2,
    ...
    //stories slider========================/
    if (($("#stries_slider").length) && (window.screen.width > 1040) && (!iPad)) {
        $('#stries_slider').slick({
            arrows: true,
            dots: false,
            slidesToShow: 5,
    ...
    //Dropdown menu========================/
    if ((window.screen.width > 1200) || (iPad)) {
  ...
  , nav_height = nav.outerHeight();
    ...
    if ((window.screen.width > 1040) || (iPad)) {
        var scroll_text;
        $(".gallery-item").on({
            mouseenter: function () {
                var $elmt = $(this);
